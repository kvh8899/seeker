...
def seed_posts():
    ...
    Would be great to hear some feedback to improve these guide :)""",heading="I'm making Arknights guide for beginner.",page_id=2,owner_id=1)
...
If you’d like to visualize how your level gains will look like, make a copy of this spreadsheet and input your total weekly and daily bounties per character.""",heading="Crucible Optimization",page_id=1,owner_id=1)
